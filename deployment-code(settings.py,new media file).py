...
# Container Commands (.ebextenstions/db-migrate.config)
container_commands:
  01_migrate:
...
# AWS S3 Static Files Configuration (settings.py)
...
# AWS S3 Media Files Configuration (greatkart/media_storages.py)
